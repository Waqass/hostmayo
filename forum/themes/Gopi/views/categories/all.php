...
echo '<h1 class="H HomepageTitle stats top">'.$this->data('Title').'</h1>';
               ...
               <div class="ItemContent Category">'
                ...
                .'</div>
                  <div class="Meta">
                     ...
                     sprintf(PluralTranslate($Category->CountComments, '%s comment html', '%s comments html', t('%s'), t('%s')), BigPlural($Category->CountComments, '%s comment'))
                     .'</span>
                     <span class="MItem DiscussionCount">'.
                     sprintf(PluralTranslate($Category->CountDiscussions, '%s discussion html', '%s discussions html', t('%s'), t('%s')), BigPlural($Category->CountDiscussions, '%s discussion'))
                     .'</span>';
