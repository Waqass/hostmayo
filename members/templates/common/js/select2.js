...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            ...
            this.opts.element.trigger($.Event("resizeddropdown"));
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            selection.bind("focus", this.bind(function() {
                if (this.container.hasClass("select2-container-disabled")) return false;
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        add: function(data) {
            ...
            if (data instanceof Array) {
                for (var i = 0; i < data.length; i++) {
                    this.addSelectedChoice(data[i]);
                    this.postprocessResults();
                    this.clearSearch();
                    this.search.width(10);
                    this.triggerChange({ added: data[i] });
                }
            } else {
        ...
        addSelectedChoice: function (data) {
            ...
            var choice=$(
                    "<li class='select2-search-choice" + ( data.disabled ? " select2-search-choice-disabled" : "" )+ "'>" +
                    "    <div></div>" +
                    ( data.disabled ? "" : "    <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'></a>" ) +
                    "</li>"),
                id = this.id(data),
                val = this.getVal(),
                formatted;
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable", "positionDropdown", "data", "add"];
